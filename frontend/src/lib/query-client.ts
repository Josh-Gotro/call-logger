...
export const queryKeys = {
  ...
  reference: {
    ...
    programManagement: () => [...queryKeys.reference.all, 'programManagement'] as const,
    programManagementHierarchy: () => [...queryKeys.reference.all, 'programManagementHierarchy'] as const,
